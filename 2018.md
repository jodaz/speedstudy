...
- [ ] Learn git and Github [Resources](#git/github).   
- [ ] Learn Vim [Resources](#vim).
...
- [ ] Create a [tribute page](https://www.freecodecamp.org/challenges/build-a-tribute-page).    
...
- [ ] Do [Javascript30](https://javascript30.com/).
- [ ] Learn React [Resources](#react-resources).
- [ ] Learn Node.js while building a small project for practice with the basics of Databases [Resources](#node.js-resources).
...
- [ ] [30Days30Sites](https://www.subscribepage.com/30days30sites).
...
- [ ]  Project: Read [How to Contribute to Open Source](#open-source-contributions-resources/) - and make two contributions to open source projects (of your choice) by the end of this Tier
...
- [ ] Build Facebook. See all the funcionality [here](https://www.theodinproject.com/courses/ruby-on-rails/lessons/final-project).
...
- [ ] Improve software development workflow [Resources](#software-development-methodology).
